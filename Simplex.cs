namespace SimplexNamespace
{
    public class Simplex
    {
        ...
        public static double[,] table = { }; //симплекс таблица
        ...
        public double[,] Calculate(double[] result)
        {
            ...
            while (!IsItEnd())
            {
                ...
                for (int j = 0; j < n; j++)
                    new_table[mainRow, j] = Math.Round(table[mainRow, j] / table[mainRow, mainCol], 2);
                ...
                for (int i = 0; i < m; i++)
                {
                    ...
                    for (int j = 0; j < n; j++)
                        new_table[i, j] = Math.Round(table[i, j] - table[i, mainCol] * new_table[mainRow, j], 2);
                }
                table = new_table;
            }
