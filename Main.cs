...
namespace MainNamespace
{
    public class MainFunction
    {
        ...
        public static double[,] GetTheSimplexTable(double[,] table_result)
        {
        ...
        public static double[] GetTheSolution(double[] variables)
        {
        ...
        public static double[,] GetTheObjectiveFunction(double[,] table_result)
        {
